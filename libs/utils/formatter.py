...
def df_rename(df: pd.DataFrame, short=True, kind=0) -> pd.DataFrame:
    ...
    rename_dict: dict = {
        ...
        "grade": "段位",
        #
        "rank1_rate-count": "1位率(数)", "rank1_rate": "1位率",
        "rank2_rate-count": "2位率(数)", "rank2_rate": "2位率",
        "rank3_rate-count": "3位率(数)", "rank3_rate": "3位率",
        "rank4_rate-count": "4位率(数)", "rank4_rate": "4位率",
        "top2_rate-count": "連対率(数)", "top2_rate": "連対率", "top2": "連対数",
        "top3_rate-count": "ラス回避率(数)", "top3_rate": "ラス回避率", "top3": "ラス回避数",
        "flying_rate-count": "トビ率(数)", "flying_rate": "トビ率", "flying_count": "トビ数",
        "yakuman_rate-count": "役満和了率(数)",
        # 収支
        "rank1_balance": "1位収支",
        "rank2_balance": "2位収支",
        "rank3_balance": "3位収支",
