...
* 差分サマリ
  * オプションに <`比較`> が追加されている場合に出力
  * 各順位から首位までのポイント差、ひとつ上の順位とのポイント差を表示
* チーム成績サマリ
...
* <`チーム`>
  * チーム成績の詳細を表示
  * プレイヤー名 + チームの指定はプレイヤーが所属するチームの成績が表示される

### 成績詳細(比較)モード
オプションにプレイヤーが2名以上指定されたときに出力

指定プレイヤーの成績詳細を並べて表示する

[入力例] 呼び出しコマンド プレイヤー名 プレイヤー名
