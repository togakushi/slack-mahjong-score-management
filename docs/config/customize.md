...
|     キー      |                        内容                        |           型           |          省略時          |                                     備考                                      |
| ------------- | -------------------------------------------------- | ---------------------- | ------------------------ | ----------------------------------------------------------------------------- |
| rule_config   | ルールセット定義ファイルを指定                     | 文字列(ファイルパス)   | `files/default_rule.ini` |                                                                               |
...
| graph_style   | グラフに使用するスタイル                           | 文字列                 | ggplot                   | [style sheets](https://matplotlib.org/stable/gallery/style_sheets/index.html) |
...
settingセクションの`keyword`とmahjongセクションの`rule_version`が設定さえれていれば`keyword = rule_version`のマッピングが設定される。
