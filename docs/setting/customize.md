...
| -------------------- | ------------------------------------------------ | ------ | ------ | :-----: | :---: | :-----: | :----: | ---------------------------------------------------- |
| commandword          | 機能を呼び出すキーワード                         | 文字列 |        |   〇    |  〇   |   〇    |   〇   |                                                      |
...
> [!TIP]
> `always_argument`で`今年`と定義した状態で`今月 先月`と指定した場合の範囲は`今月 先月`となる。<br />
> 日付指定がない場合は`今年`が範囲になる。
...
|        キー        |                        内容                        |   型   |    省略時    | 備考 |
| ------------------ | -------------------------------------------------- | ------ | ------------ | ---- |
| commandword        | メンバー一覧を表示するコマンドの呼び出すキーワード | 文字列 | メンバー一覧 |      |
...
|        キー        |                       内容                       |   型   |   省略時   | 備考 |
| ------------------ | ------------------------------------------------ | ------ | ---------- | ---- |
| commandword        | チーム一覧を表示するコマンドを呼び出すキーワード | 文字列 | チーム一覧 |      |
