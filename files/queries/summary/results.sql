...
select
    ...
    round(avg(case when rank = 1 then rpoint * 100  else null end) - :origin_point * 100, 1) as '1位収支',
    round(avg(case when rank = 2 then rpoint * 100  else null end) - :origin_point * 100, 1) as '2位収支',
    round(avg(case when rank = 3 then rpoint * 100  else null end) - :origin_point * 100, 1) as '3位収支',
    round(avg(case when rank = 4 then rpoint * 100  else null end) - :origin_point * 100, 1) as '4位収支',
