...
select
    ...
    round(avg(case when rank <= 2  then rpoint * 100 else null end) - :origin_point * 100, 1) as '連対収支',
    round(avg(case when rank >= 3 then rpoint * 100 else null end) - :origin_point * 100, 1) as '逆連対収支',
    round(avg(case when rank = 1 then rpoint * 100  else null end) - :origin_point * 100, 1) as 'rank1_balance',
    round(avg(case when rank = 2 then rpoint * 100  else null end) - :origin_point * 100, 1) as 'rank2_balance',
    round(avg(case when rank = 3 then rpoint * 100  else null end) - :origin_point * 100, 1) as 'rank3_balance',
    round(avg(case when rank = 4 then rpoint * 100  else null end) - :origin_point * 100, 1) as 'rank4_balance',
    ...
    sum(case when seat = 1 then yakuman_count end) as '東家-役満和了',
    ...
    sum(case when seat = 2 then yakuman_count end) as '南家-役満和了',
    ...
    sum(case when seat = 3 then yakuman_count end) as '西家-役満和了',
    ...
    sum(case when seat = 4 then yakuman_count end) as '北家-役満和了',
