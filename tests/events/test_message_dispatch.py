...
def test_help(config, keyword, monkeypatch):
    ...
    with (
        ...
        patch("libs.functions.events.message_event.slack.post.post_message", return_value=True),
        patch("libs.functions.events.message_event.slack.post.post_text", return_value=True),
