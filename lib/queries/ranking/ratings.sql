...
select
    ...
    --[individual] --[unregistered_not_replace] case when p1_guest = 0 or p1_name = :guest_name then p1_name else p1_name || '(<<guest_mark>>)' end as p1_name, -- ゲスト無効
    ...
    --[individual] --[unregistered_not_replace] case when p2_guest = 0 or p2_name = :guest_name then p2_name else p2_name || '(<<guest_mark>>)' end as p2_name, -- ゲスト無効
    ...
    --[individual] --[unregistered_not_replace] case when p3_guest = 0 or p3_name = :guest_name then p3_name else p3_name || '(<<guest_mark>>)' end as p3_name, -- ゲスト無効
    ...
    --[individual] --[unregistered_not_replace] case when p4_guest = 0 or p4_name = :guest_name then p4_name else p4_name || '(<<guest_mark>>)' end as p4_name, -- ゲスト無効
