...
def main():
    ...
    logging.notice("file size: %s -> %s", before_size, after_size)
    logging.notice("page_count: %s -> %s", before_page, after_page)
    logging.notice("freelist_count: %s -> %s", before_freelist, after_freelist)
